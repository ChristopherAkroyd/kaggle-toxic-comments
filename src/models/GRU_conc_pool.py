...
class GRUConcPool:
    def __init__(self, num_classes=NUM_CLASSES):
        ...
        self.checkpoint_path = './model_checkpoints/GRUConcPool.hdf5'
    ...
    def create_model(self, vocab_size, embedding_matrix, input_length=5000, embed_dim=200):
        ...
        bi_gru_1, last_state = CuDNNGRU(64, return_sequences=True, return_state=True,
                                        recurrent_regularizer=l2(0.00001))(noise)
