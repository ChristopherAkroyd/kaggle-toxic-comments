...
class TextCNN:
    ...
    def create_model(self, vocab_size, embedding_matrix, input_length=5000, embed_dim=200):
        ...
        conv_2 = Conv1D(128, kernel_size=2, padding='same', kernel_regularizer=l2(0.0001))(noise)
        conv_2 = BatchNormalization()(conv_2)
        conv_2 = Activation('relu')(conv_2)
        max_2 = MaxPool1D()(conv_2)
        max_2 = GlobalMaxPool1D()(max_2)

        conv_3 = Conv1D(128, kernel_size=3, padding='same', kernel_regularizer=l2(0.0001))(noise)
        conv_3 = BatchNormalization()(conv_3)
        conv_3 = Activation('relu')(conv_3)
        max_3 = MaxPool1D()(conv_3)
        max_3 = GlobalMaxPool1D()(max_3)

        conv_4 = Conv1D(128, kernel_size=4, padding='same', kernel_regularizer=l2(0.0001))(noise)
        conv_4 = BatchNormalization()(conv_4)
        conv_4 = Activation('relu')(conv_4)
        max_4 = MaxPool1D()(conv_4)
        max_4 = GlobalMaxPool1D()(max_4)

        conv_5 = Conv1D(128, kernel_size=5, padding='same', kernel_regularizer=l2(0.0001))(noise)
